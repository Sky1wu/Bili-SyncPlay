...
export const MEMBER_KICKED_REJOIN_MESSAGE = "You were removed from the room by an admin. Rejoin the room.";
export const ROOM_FULL_MESSAGE = "Room is full.";
export const ROOM_HAS_NO_SHARED_VIDEO_MESSAGE = "The room does not have a shared video yet.";
export const PLAYBACK_URL_MISMATCH_MESSAGE = "Playback URL does not match the current shared video.";
export const UNAUTHORIZED_MESSAGE = "Unauthorized.";
export const FORBIDDEN_MESSAGE = "Forbidden.";
export const ADMIN_AUTH_UNAVAILABLE_MESSAGE = "Admin authentication is not configured.";
...
export const ROOM_ACTIVE_MESSAGE = "Room still has active members. Close the room instead of expiring it early.";
